...
export const AboutMock: AboutMockType[] = [
  {
    id: 1,
    ...
    paragraphs: [
      {
        id: 1,
        subtitle: "Como funciona a cura de um pokémon?",
      ...
      {
        id: 2,
        subtitle: "Uma tradição de mais de 20 anos",
      ...
      {
        id: 3,
        subtitle: "O melhor para seu pokémon",
